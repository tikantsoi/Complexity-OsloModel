...
#%%
"""
steadyAvalanches = a[1][0][903550:]

steadyAvalanches2 = [ele**2 for ele in steadyAvalanches]

sCenters, prob = logbin(data = steadyAvalanches2, scale = 1., zeros = False)

#%%

import cProfile

cProfile.run("logbin(data = steadyAvalanches2, scale = 1., zeros = False)")
"""